...
const features = [
  {
    title: 'Hero',
    description:
      "Gambar besar dan indah yang memenuhi seluruh layar, dengan judul dan tombol ajakan bertindak. Ini adalah hal pertama yang dilihat orang ketika mereka mengunjungi situs web Anda.",
    image: screenshotMtLanding,
  },
  {
    title: 'Klien',
    description:
      "Daftar klien yang mempercayai bisnis Anda, dengan logo dan nama perusahaan. Ini memberikan kepercayaan kepada pengunjung situs web Anda bahwa mereka berada di tempat yang tepat.",
    image: screenshotMtLandingKlien,
  },
  {
    ...
    image: screenshotLayananProduk,
  },
  {
    title: 'Tentang',
    description:
      'Cerita tentang bisnis Anda, dengan gambar dan teks. Ini membantu pengunjung situs web Anda memahami siapa Anda dan mengapa mereka harus mempercayai Anda.',
    image: screenshotTentang,
  },
]
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl">
            Fitur-fitur utama MT Landing Page
          </h2>
          <p className="mt-6 text-lg tracking-tight text-teal-100">
            Kami menyediakan fitur-fitur yang lengkap untuk membantu Anda membuat website bisnis Anda dalam waktu singkat.
          </p>
        </div>
        <Tab.Group
          as="div"
